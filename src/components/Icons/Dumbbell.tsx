...
export function Dumbbell({ className }: { className?: string }) {
  const prefs = useSelector(
    (stateSelector: RootState) => stateSelector.systemModule.prefs
  )
  return (
    <div className={`custom-svg-icon dumbbell ${className}`}>
      {prefs.isDarkMode ? (
        <svg
          viewBox="0 0 24 24"
          fill="none"
        ...
        >
          ...
          <g id="SVGRepo_iconCarrier">
            ...
            ></path>{' '}
            <path
              d="M5 10H4C2.89543 10 2 10.8954 2 12C2 13.1046 2.89543 14 4 14H5M9 12H15M19 14H20C21.1046 14 22 13.1046 22 12C22 10.8954 21.1046 10 20 10H19"
              stroke="#ffffff"
              strokeWidth="1.5"
            ></path>{' '}
          </g>
